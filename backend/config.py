...
# Dockerized Scanners settings
USE_DOCKER = os.getenv("USE_DOCKER", "true").lower() == "true"
DOCKER_NMAP_IMAGE = os.getenv("DOCKER_NMAP_IMAGE", "instrumentisto/nmap:latest")
DOCKER_SUBFINDER_IMAGE = os.getenv("DOCKER_SUBFINDER_IMAGE", "projectdiscovery/subfinder:latest")
DOCKER_AMASS_IMAGE = os.getenv("DOCKER_AMASS_IMAGE", "caffix/amass:latest")
