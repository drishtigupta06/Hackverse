...
const NAV_ITEMS = [
    { id: "dashboard", icon: DashboardIcon, label: "Dashboard", url: "/dashboard.html" },
    { id: "scan", icon: ScanIcon, label: "Launch Scan", url: "/scan.html" },
    { id: "results", icon: ResultsIcon, label: "Results", url: "/results.html" },
    { id: "graph", icon: GraphIcon, label: "Attack Graph", url: "/graph.html" },
    { id: "chat", icon: ChatIcon, label: "AI Chat", url: "/chat.html" },
    { id: "chathistory", icon: HistoryIcon, label: "Chat History", url: "/chathistory.html" },
    { id: "cvelookup", icon: SearchIcon, label: "CVE Lookup", url: "/cvelookup.html" },
    { id: "reports", icon: DocumentIcon, label: "Reports", url: "/reports.html" },
    { id: "tasks", icon: SettingsIcon, label: "Task Monitor", url: "/tasks.html" },
];
            ...
            <div className="sidebar">
                <div className="sidebar-logo">
                    <div className="sidebar-logo-icon" style={{ background: "none" }}>
                        <ShieldIcon size={24} style={{ color: "var(--accent)" }} />
                    </div>
