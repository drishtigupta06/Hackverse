...
import { GraphIcon, AlertCircleIcon } from "../components/Icons.jsx";
                ...
                {nodes.map(n => {
                    ...
                    return (
                        <g key={n.id} transform={`translate(${p.x},${p.y})`}
                            ...
                            <text textAnchor="middle" dominantBaseline="middle" fontSize={n.type === "attacker" ? 10 : 9} fill="currentColor" style={{ userSelect: "none" }}>{
                                n.type === "attacker" ? "A" :
                                    n.type === "host" ? "H" :
                                        n.type === "service" ? "S" :
                                            n.type === "vulnerability" ? "V" : "E"
                            }</text>
        ...
        <div className="fade-in">
            <div className="page-header">
                <div>
                    <div className="page-title" style={{ display: "inline-flex", alignItems: "center", gap: 10 }}>
                        <GraphIcon size={24} style={{ color: "var(--accent)" }} /> Attack Graph
                    </div>
            ...
            {graphData && (
                <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginBottom: 20 }}>
                    {[
                        { type: "attacker", icon: "A", label: "Attacker", color: "#ef4444" },
                        { type: "host", icon: "H", label: "Host", color: "#6366f1" },
                        { type: "service", icon: "S", label: "Service/Port", color: "#06b6d4" },
                        { type: "vulnerability", icon: "V", label: "Vulnerability", color: "#d97706" },
                        { type: "exploit", icon: "E", label: "Exploit", color: "#dc2626" },
            ...
            {loading ? (
                ...
                <div className="alert alert-error" style={{ display: "inline-flex", alignItems: "center", gap: 6 }}><AlertCircleIcon size={14} /> {error}</div>
            ) : !graphData ? (
                ...
                <div className="card" style={{ padding: 16 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                        <div style={{ fontSize: 13, color: "var(--text-secondary)" }}>
                            Tip: Click nodes to view details. Drag to rearrange. Graph shows {graphData.nodes?.length} nodes.
                        </div>
