...
import { ChatIcon, SearchIcon, HistoryIcon, ShieldIcon } from "../components/Icons.jsx";
        ...
        <div className="fade-in">
            <div className="page-header">
                <div>
                    <div className="page-title" style={{ display: "inline-flex", alignItems: "center", gap: 10 }}>
                        <HistoryIcon size={24} style={{ color: "var(--accent)" }} /> Chat History
                    </div>
            ...
            {loading ? (
                ...
                <div className="empty-state">
                    <ChatIcon size={48} style={{ opacity: 0.4, marginBottom: 12 }} />
                                ...
                                <div style={{ marginTop: 16, paddingTop: 16, borderTop: "1px solid var(--border)" }}>
                                    <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                                        <div style={{
                                            ...
                                            <ShieldIcon size={14} style={{ color: "#fff" }} />
                                        </div>
                                        <div style={{
