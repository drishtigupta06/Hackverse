...
import { Brain, AlertTriangle, Shield, RefreshCw } from "lucide-react";
    ...
    return (
        <div className="fade-in" style={{ paddingBottom: 60 }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 30 }}>
                ...
                {simulation && (
                    <button onClick={fetchData} className="btn btn-outline" style={{ fontSize: 12, display: "inline-flex", alignItems: "center", gap: 6 }}>
                        <RefreshCw size={14} /> Regenerate Simulation
                    </button>
                )}
            </div>
            ...
            {loading && (
                <div style={{ padding: 80, textAlign: "center", color: "var(--text-muted)" }}>
                    <Brain size={60} style={{ marginBottom: 20, color: "var(--cyan)", animation: "pulse 2s infinite" }} />
            ...
            {simulation && !loading && (
                <div className="fade-in" style={{ maxWidth: 800, margin: "0 auto", position: "relative", paddingTop: 20 }}>
                    ...
                    <div style={{ display: "flex", gap: 30, position: "relative", zIndex: 1 }}>
                        ...
                        }}><Shield size={24} style={{ color: "var(--red)" }} /></div>
