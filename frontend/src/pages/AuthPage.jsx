...
import { ShieldIcon, AlertCircleIcon } from "../components/Icons.jsx";
    ...
    async function handleSubmit(e) {
        ...
        try {
            if (tab === "login") {
                ...
                await api.register(username, password, email, orgName);
            ...
            <div className="auth-card fade-in">
                <div className="auth-logo">
                    <div className="auth-logo-icon" style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <ShieldIcon size={28} style={{ color: "#fff" }} />
                    </div>
                ...
                {error && <div className="alert alert-error" style={{ display: "inline-flex", alignItems: "center", gap: 6 }}><AlertCircleIcon size={14} /> {error}</div>}
                    ...
                    {tab === "register" && (
                        <>
                            ...
                            <div className="input-group">
                                ...
                                <input className="input" placeholder="e.g. AcmeCorp" value={orgName}
