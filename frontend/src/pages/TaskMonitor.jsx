...
import { ScanIcon, SettingsIcon, ResultsIcon, AlertCircleIcon } from "../components/Icons.jsx";
...
const TaskMonitor = () => {
    ...
    return (
        <div className="fade-in">
            <div className="page-header">
                <div>
                    <div className="page-title" style={{ display: "inline-flex", alignItems: "center", gap: 10 }}>
                        <SettingsIcon size={24} style={{ color: "var(--accent)" }} /> Task Monitor
                    </div>
            ...
            {error && (
                <div className="alert alert-error" style={{ marginBottom: 24, display: "inline-flex", alignItems: "center", gap: 6 }}>
            ...
            <div className="stats-grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))" }}>
                <div className="stat-card">
                    <div className="stat-icon" style={{ background: "rgba(16, 185, 129, 0.1)", color: "var(--green)", display: "flex", alignItems: "center", justifyContent: "center" }}><ScanIcon size={18} /></div>
                    <div>
                ...
                <div className="stat-card">
                    <div className="stat-icon" style={{ background: "rgba(99, 102, 241, 0.1)", color: "var(--accent-light)", display: "flex", alignItems: "center", justifyContent: "center" }}><SettingsIcon size={18} /></div>
                    <div>
                ...
                <div className="stat-card">
                    <div className="stat-icon" style={{ background: "rgba(6, 182, 212, 0.1)", color: "var(--cyan)", display: "flex", alignItems: "center", justifyContent: "center" }}><ResultsIcon size={18} /></div>
                    <div>
            ...
            <div className="card" style={{ padding: 0, overflow: "hidden" }}>
                <div className="card-title" style={{ padding: "20px 24px", margin: 0, borderBottom: "1px solid var(--border)", display: "inline-flex", alignItems: "center", gap: 8 }}>
                    <ResultsIcon size={18} style={{ color: "var(--accent)" }} /> Active & Recent Tasks
                </div>
                            ...
                            {tasks.length === 0 && !loading && (
                                <tr>
                                    <td colSpan="5" style={{ textAlign: "center", padding: 60, color: "var(--text-muted)" }}>
                                        <ScanIcon size={40} style={{ opacity: 0.5, marginBottom: 12 }} />
                                        <div>Awaiting task dispatch...</div>
                                    </td>
                                </tr>
                            )}
                            {tasks.map((task) => (
                ...
                <div style={{ padding: "16px 24px", background: "var(--bg-secondary)", borderTop: "1px solid var(--border)", display: "flex", gap: 20 }}>
