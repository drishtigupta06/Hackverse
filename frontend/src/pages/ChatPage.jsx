...
import { ShieldIcon, SearchIcon, ChatIcon } from "../components/Icons.jsx";
    ...
    return (
        <div className={`chat-message ${isUser ? "user" : ""}`}>
            <div className={`chat-avatar ${isUser ? "user" : "ai"}`}>
                {isUser ? <SearchIcon size={14} /> : <ShieldIcon size={14} />}
            </div>
...
export default function ChatPage({ user }) {
    ...
    return (
            ...
            <div className="page-header">
                <div>
                    <div className="page-title" style={{ display: "inline-flex", alignItems: "center", gap: 10 }}>
                        <ChatIcon size={24} style={{ color: "var(--accent)" }} /> CyberGuard AI Chat
                    </div>
                ...
                <div className="chat-messages">
                    ...
                    {loading && (
                        <div className="chat-message">
                            <div className="chat-avatar ai"><ShieldIcon size={14} /></div>
        ...
        .markdown-body code { font-family: var(--font-mono); font-size: 12px; background: var(--bg-secondary); padding: 2px 6px; border-radius: 4px; }
        .markdown-body pre { background: var(--bg-secondary); padding: 10px; border-radius: var(--radius-sm); margin: 8px 0; overflow-x: auto; }
